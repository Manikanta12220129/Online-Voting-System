...
?>
        <!-- Card Start -->
          <div class="col-md-3 " style=" margin-left:25px; padding-top: 30px;">
                ...
                <img src="img/PRP1.png" class="card-img-top" alt="Candidate Image" style="height: 200px;">                <!-- <img src="img/PRP1.png"width=""height="300"> -->
                  <!-- <img class="card-img-top" src="img/PRP1.png" alt="shinzo" height="350px">
                  <img class="card-img-top" src="img/bjp1.jpg" alt="shinzo" height="350px">
                  <img class="card-img-top" src="img/PRP1.png" alt="shinzo" height="350px"> -->
